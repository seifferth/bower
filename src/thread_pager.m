...
compare_message_flat_timestamp(A, B, Rel) :-
    (
        is_reaction(A), is_reaction(B),
        A ^ mf_maybe_parent = yes(_),
        B ^ mf_maybe_parent = yes(_),
        A ^ mf_maybe_parent = B ^ mf_maybe_parent
    ->
...
append_flat_message(Nowish, MessageFlat, MaybePrevSubject, MaybeSubject,
        !RevAcc, !IO) :-
    MessageFlat = message_flat(Message, MaybeParentId, _),
