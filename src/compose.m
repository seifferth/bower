...
draw_crypto_line(Attrs, Screen, Panel, CryptoInfo, !IO) :-
    ...
    (
        Encrypt = yes,
        Sign = yes,
        Body = "encrypt message body and subject & sign entire message"
    ;
        Encrypt = yes,
        Sign = no,
        Body = "encrypt message body and subject"
    ;
        Encrypt = no,
        Sign = yes,
        Body = "sign message"
    ...
    ;
        ...
        ;
            ...
            ;
                ...
                make_protected_headers(WriteHeaders, cipher, EnvelopeHeaders,
                    ProtectedHeaders),
        ...
        ;
            ...
            ;
                SignKeys = [_ | _],
                make_protected_headers(WriteHeaders, clear, EnvelopeHeaders,
                    ProtectedHeaders),
                ...
                (
                    ...
                    curs.soft_suspend(
                        sign_detached_then_write_temp_message_file(Config, Prepare,
                            EnvelopeHeaders, PartToSign, CryptoInfo, SignKeys,
...
make_protected_headers(AllHeaders, ProtectionType, EnvelopeHeaders,
        ProtectedHeaders) :-
    (
        ProtectionType = cipher,
        list.filter_map(mask_envelope_header, AllHeaders, EnvelopeHeaders)
    ;
        ProtectionType = clear,
        EnvelopeHeaders = AllHeaders
    ),
    list.map(make_hp_outer, EnvelopeHeaders, HPOuterHeaders),
    InnerHeaders = AllHeaders ++ HPOuterHeaders,
    ProtectedHeaders = protected_headers(ProtectionType, InnerHeaders).

:- pred mask_envelope_header(header::in, header::out) is semidet.

mask_envelope_header(InnerHeader, OuterHeader) :-
